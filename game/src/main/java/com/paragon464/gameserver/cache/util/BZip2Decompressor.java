package com.paragon464.gameserver.cache.util;
    ...
    private static final void method1793(BZip2BlockEntry entry) {
        ...
        while (flag18) {
            ...
            for (int l3 = 0; l3 < j4; l3++) {
                ...
                method1786(entry.anIntArrayArray2230[l3], entry.anIntArrayArray2218[l3], entry.anIntArrayArray2210[l3],
            ...
            for (int k5 = ai2[k7 - ai1[l6]]; k5 != l4; ) {
                if (k5 == 0 || k5 == 1) {
                    ...
                    if (i11 < 16) {
                        ...
                        for (; k10 > 0; k10--) {
                            entry.anIntArray2226[k10]--;
                            entry.aByteArray2204[entry.anIntArray2226[k10]] = entry.aByteArray2204[(entry.anIntArray2226[k10
                                - 1] + 16) - 1];
                        }
