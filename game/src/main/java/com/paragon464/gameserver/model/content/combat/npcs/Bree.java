...
public class Bree extends NPCAttackLayout {
    ...
    public void executeAttacks(NPC npc, Mob mainTarget) {
        ...
        Projectiles rangeProjectile = Projectiles.create(npc.getPosition(), mainTarget.getPosition(), mainTarget, 1188,
            45, 55, 50, 50, 40, 16, 48);
