...
public class ZamorakKreeyath extends NPCAttackLayout {
    ...
    public void executeAttacks(NPC npc, Mob mainTarget) {
        ...
        Projectiles mageProjectile = Projectiles.create(npc.getPosition(), mainTarget.getPosition(), mainTarget, 1213,
            35, 75, 50, 20, 40, 15, 48);
        npc.executeProjectile(mageProjectile);
        npc.playGraphic(1212, 0, 100);
