...
public class ElfWarrior extends NPCAttackLayout {
    ...
    public void executeAttacks(NPC npc, Mob mainTarget) {
        ...
        Projectiles rangeProjectile = Projectiles.create(npc.getPosition(), mainTarget.getPosition(), mainTarget, 249,
            45, 55, 50, 45, 40, 15, 48);
        npc.executeProjectile(rangeProjectile);
        npc.playGraphic(250, 0, 100);
