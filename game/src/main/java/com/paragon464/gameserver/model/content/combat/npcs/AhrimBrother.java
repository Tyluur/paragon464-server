...
public class AhrimBrother extends NPCAttackLayout {
    ...
    public void executeAttacks(NPC npc, Mob mainTarget) {
        ...
        Projectiles mageProjectile = Projectiles.create(npc.getPosition(), mainTarget.getPosition(), mainTarget, 162,
            20, clientSpeed, 50, 45, 40, 15, 48);
    ...
    public boolean isWithinRadius(NPC npc, Mob target) {
        return !TileControl.locationOccupied(npc, target) && npc.getPosition().isWithinRadius(target.getPosition(), 8);
    }
