...
public class Aviansie extends NPCAttackLayout {
    ...
    public void executeAttacks(NPC npc, Mob mainTarget) {
        ...
        Projectiles rangeProjectile = Projectiles.create(npc.getPosition(), mainTarget.getPosition(), mainTarget, 1191,
            45, 55, 50, 95, 40, 15, 48);
