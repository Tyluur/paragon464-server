...
public enum UnfinishedPotionData {
    ...
    UnfinishedPotionData(int unfinishedPotion, int herbNeeded, int levelReq) {
        this.unfinishedPotion = unfinishedPotion;
        this.herbNeeded = herbNeeded;
        this.levelReq = levelReq;
    }

    public static final UnfinishedPotionData forId(int herbId) {
        for (final UnfinishedPotionData unf : UnfinishedPotionData.values()) {
