...
public enum FinishedPotionData {
    ...
    FinishedPotionData(int finishedPotion, int unfinishedPotion, int itemNeeded, int levelReq, int expGained) {
    ...
    public static final FinishedPotionData forId(int unfPotion, int secondary) {
        for (final FinishedPotionData pot : FinishedPotionData.values()) {
            if (pot.getUnfinishedPotion() == unfPotion && pot.getItemNeeded() == secondary) {
                return pot;
            }
        }
        return null;
